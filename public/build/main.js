...
define('core/transition',['require'],function (require) {
	var transition = {
		duration: 700,
...
define('core/viewManager',['require','jQuery','./transition'],function (require) {
	var $ = require('jQuery');
...
/* START_TEMPLATE */
define('hbs!apps/home/templates/HeaderView',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  ...
  buffer += escapeExpression(stack1) + "</h3>\r\n    </div>\r\n    <p>\r\n    </p>\r\n    <div class=\"btn-large\" data-transition=\"bounce-in\"> <a href=\"/recent\">View Recent</a></div>\r\n</div>\r\n";
  return buffer;});
Handlebars.registerPartial('apps_home_templates_HeaderView', t);
return t;
});
/* END_TEMPLATE */
;
define('apps/home/views/HeaderView',['require','Backbone','hbs!./../templates/HeaderView'],function (require) {
...
/* START_TEMPLATE */
define('hbs!apps/home/templates/FooterView',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  


  return "<div class=\"footer\">\r\n	<p><a href='http://twitter.com/dswabster'>@dswabster</a></p>\r\n</div>";});
Handlebars.registerPartial('apps_home_templates_FooterView', t);
return t;
});
/* END_TEMPLATE */
;
define('apps/home/views/FooterView',['require','Backbone','hbs!./../templates/FooterView'],function (require) {
	var Backbone = require('Backbone');
...
define('apps/home/views/MainView',['require','Backbone','./HeaderView','./FooterView','velocity'],function (require) {
	var Backbone = require('Backbone');
...
define('apps/home/app',['require','./views/MainView'],function(require) {
...
define('apps/inbox/models/Email',['require','Backbone'],function(require) {
	var Backbone = require('Backbone');
...
define('apps/inbox/collections/EmailsCollection',['require','Backbone','./../models/Email'],function (require) {
	var Backbone = require('Backbone');
...
/* START_TEMPLATE */
define('hbs!apps/inbox/templates/ButtonsView',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  


  return "<div class=\"row\">\r\n	<p><a class=\"btn btn-large\" href=\"/inbox/compose\">Compose mail</a></p>\r\n</div>";});
Handlebars.registerPartial('apps_inbox_templates_ButtonsView', t);
return t;
});
/* END_TEMPLATE */
;
define('apps/inbox/views/subviews/ButtonsView',['require','Backbone','hbs!./../../templates/ButtonsView'],function(require) {
	var Backbone = require('Backbone');
...
/* START_TEMPLATE */
define('hbs!apps/inbox/templates/EmailView',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  var buffer = "", stack1, foundHelper, functionType="function", escapeExpression=this.escapeExpression;


  buffer += "<td><span style=\"color: red\">";
  ...
  buffer += escapeExpression(stack1) + "</td>\r\n<td>";
  foundHelper = helpers.sentDate;
  if (foundHelper) { stack1 = foundHelper.call(depth0, {hash:{}}); }
  else { stack1 = depth0.sentDate; stack1 = typeof stack1 === functionType ? stack1() : stack1; }
  buffer += escapeExpression(stack1) + "</td>";
  return buffer;});
Handlebars.registerPartial('apps_inbox_templates_EmailView', t);
return t;
});
/* END_TEMPLATE */
;
define('apps/inbox/views/subviews/EmailView',['require','Backbone','hbs!./../../templates/EmailView'],function (require) {
	var Backbone = require('Backbone');
...
/* START_TEMPLATE */
define('hbs!apps/inbox/templates/InboxView',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
...
Handlebars.registerPartial('apps_inbox_templates_InboxView', t);
return t;
});
/* END_TEMPLATE */
;
define('apps/inbox/views/subviews/InboxView',['require','Backbone','./EmailView','hbs!./../../templates/InboxView'],function(require) {
	var Backbone = require('Backbone');
...
define('apps/inbox/views/MainView',['require','Backbone','./subviews/ButtonsView','./subviews/InboxView'],function(require) {
	var Backbone = require('Backbone');
...
define('apps/inbox/app',['require','./collections/EmailsCollection','./views/MainView'],function (require) {
...
/* START_TEMPLATE */
define('hbs!apps/inbox/subapps/compose/templates/ComposeEmailView',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  


  return "<form>\r\n    <div class=\"alerts\"></div>\r\n    <div class=\"control-group email\">\r\n        <label>To:</label>\r\n        <input type=\"text\" id=\"to\">\r\n        <span class=\"help-inline\"></span>\r\n    </div>\r\n    <div class=\"control-group to\">\r\n        <label>CC:</label>\r\n        <input type=\"text\" id=\"cc\">\r\n        <span class=\"help-inline\"></span>\r\n    </div>\r\n    <div class=\"control-group subject\">\r\n        <label>Subject:</label>\r\n        <input type=\"text\" class=\"input-xxlarge\" id=\"subject\">\r\n        <span class=\"help-inline\"></span>\r\n    </div>\r\n    <div class=\"control-group message\">\r\n        <label>Message</label>\r\n        <textarea id=\"message\" class=\"input-xxlarge\" placeholder=\"Feedback text...\" rows=\"6\"></textarea>\r\n        <span class=\"help-inline\"></span>\r\n    </div>\r\n    <button type=\"submit\" id=\"send\" class=\"btn\">Send</button>\r\n</form>\r\n";});
Handlebars.registerPartial('apps_inbox_subapps_compose_templates_ComposeEmailView', t);
return t;
});
/* END_TEMPLATE */
;
define('apps/inbox/subapps/compose/views/subviews/ComposeEmailView',['require','Backbone','hbs!./../../templates/ComposeEmailView'],function (require) {
	var Backbone = require('Backbone');
...
define('apps/inbox/subapps/compose/views/MainView',['require','Backbone','./subviews/ComposeEmailView'],function (require) {
	var Backbone = require('Backbone');
...
define('apps/inbox/subapps/compose/app',['require','./views/MainView','./../../models/Email'],function(require) {
	var MainView = require('./views/MainView');
	var Email = require('./../../models/Email');
...
define('apps/charts/models/Contact',['require','Backbone'],function(require) {
	var Backbone = require('Backbone');
...
define('apps/charts/collections/ContactsCollection',['require','Backbone','./../models/Contact'],function (require) {
	var Backbone = require('Backbone');
...
/* START_TEMPLATE */
define('hbs!apps/charts/templates/ContactView',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  var buffer = "", stack1, foundHelper, functionType="function", escapeExpression=this.escapeExpression;
  ...
  buffer += escapeExpression(stack1) + "</td>\r\n<td>";
  foundHelper = helpers.phoneNumber;
  if (foundHelper) { stack1 = foundHelper.call(depth0, {hash:{}}); }
  else { stack1 = depth0.phoneNumber; stack1 = typeof stack1 === functionType ? stack1() : stack1; }
  buffer += escapeExpression(stack1) + "</td>\r\n<td>";
  ...
  buffer += escapeExpression(stack1) + "</td>";
  return buffer;});
Handlebars.registerPartial('apps_charts_templates_ContactView', t);
return t;
});
/* END_TEMPLATE */
;
define('apps/charts/views/subviews/ContactView',['require','Backbone','hbs!./../../templates/ContactView'],function (require) {
	var Backbone = require('Backbone');
...
/* START_TEMPLATE */
define('hbs!apps/charts/templates/ContactsView',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
...
Handlebars.registerPartial('apps_charts_templates_ContactsView', t);
return t;
});
/* END_TEMPLATE */
;
define('apps/charts/views/subviews/ContactsView',['require','Backbone','./ContactView','hbs!./../../templates/ContactsView'],function(require) {
	var Backbone = require('Backbone');
...
/* START_TEMPLATE */
define('hbs!apps/charts/templates/GlucoseChartView',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  


  return "<div class=\"chart-wrapper\">\n  <div class=\"chart-header\">Blood Glucose</div>\n  <div id=\"glucose-chart\"></div>\n</div>";});
Handlebars.registerPartial('apps_charts_templates_GlucoseChartView', t);
return t;
});
/* END_TEMPLATE */
;
define('apps/charts/views/subviews/GlucoseChartView',['require','Backbone','hbs!./../../templates/GlucoseChartView'],function (require) {
  var Backbone = require('Backbone');
...
define('apps/charts/views/MainView',['require','Backbone','./subviews/ContactsView','./subviews/GlucoseChartView'],function(require) {
	var Backbone = require('Backbone');
...
define('apps/charts/app',['require','./collections/ContactsCollection','./views/MainView'],function (require) {
...
/* START_TEMPLATE */
define('hbs!apps/status/templates/StatusView',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  


  return "<div class=\"status-wrapper\">\n  <div class=\"item connected\">\n    <span class=\"icon-cross\"></span>\n    <span class=\"item-text\">Connected</span>\n  </div>\n  <div class=\"item activity\">\n    <span class=\"icon-cross\"></span>\n    <span class=\"item-text\">Inactive</span>\n  </div>\n  <div class=\"item on-treadmill\">\n    <span class=\"icon-cross\"></span>\n    <span class=\"item-text\">Treadmill</span>\n  </div>\n  <div class=\"item running\">\n    <span class=\"icon-cross\"></span>\n    <span class=\"item-text\">Mph</span>\n  </div>\n</div>";});
Handlebars.registerPartial('apps_status_templates_StatusView', t);
return t;
});
/* END_TEMPLATE */
;
define('apps/status/views/subviews/StatusView',['require','Backbone','hbs!./../../templates/StatusView'],function (require) {
  var Backbone = require('Backbone');
...
/* START_TEMPLATE */
define('hbs!apps/status/templates/LocationView',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  


  return "  <div class=\"location-title\">\n    Last Seen\n  </div>\n  <div class=\"location-title\" style=\"display:none;\">\n    Current Location\n  </div>\n  <div class=\"map-container\"></div>\n";});
Handlebars.registerPartial('apps_status_templates_LocationView', t);
return t;
});
/* END_TEMPLATE */
;
define('apps/status/views/subviews/LocationView',['require','Backbone','hbs!./../../templates/LocationView'],function (require) {
  var Backbone = require('Backbone');
...
define('apps/status/views/MainView',['require','Backbone','./subviews/StatusView','./subviews/LocationView'],function(require) {
  var Backbone = require('Backbone');
...
define('apps/status/app',['require','./views/MainView'],function(require) {
  var MainView = require('./views/MainView');
...
define('apps/pics/models/Picture',['require','Backbone'],function (require) {
  var Backbone = require('Backbone');
...
define('apps/pics/collections/PicturesCollection',['require','Backbone','./../models/Picture'],function (require) {
  var Backbone = require('Backbone');
...
/* START_TEMPLATE */
define('hbs!apps/pics/templates/PictureView',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  var buffer = "", stack1, foundHelper, functionType="function", escapeExpression=this.escapeExpression;


  buffer += "<div class=\"picture\">\r\n  <img src=\"";
  foundHelper = helpers.imagePath;
  if (foundHelper) { stack1 = foundHelper.call(depth0, {hash:{}}); }
  else { stack1 = depth0.imagePath; stack1 = typeof stack1 === functionType ? stack1() : stack1; }
  buffer += escapeExpression(stack1) + "\" >\r\n</div>";
  return buffer;});
Handlebars.registerPartial('apps_pics_templates_PictureView', t);
return t;
});
/* END_TEMPLATE */
;
define('apps/pics/views/subviews/PictureView',['require','Backbone','hbs!./../../templates/PictureView'],function (require) {
  var Backbone = require('Backbone');
...
/* START_TEMPLATE */
define('hbs!apps/pics/templates/PicturesView',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  


  return "<div class=\"pictures\"></div>\n";});
Handlebars.registerPartial('apps_pics_templates_PicturesView', t);
return t;
});
/* END_TEMPLATE */
;
define('apps/pics/views/subviews/PicturesView',['require','Backbone','./PictureView','hbs!./../../templates/PicturesView'],function(require) {
  var Backbone = require('Backbone');
...
/* START_TEMPLATE */
define('hbs!apps/pics/templates/RunningManView',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  


  return "<div id=\"audio-toggle\">Toggle Audio On</div>\r\n";});
Handlebars.registerPartial('apps_pics_templates_RunningManView', t);
return t;
});
/* END_TEMPLATE */
;
define('apps/pics/views/subviews/RunningManView',['require','Backbone','hbs!./../../templates/RunningManView'],function (require) {
	var Backbone = require('Backbone');
  var audio = undefined;
...
define('apps/pics/views/MainView',['require','Backbone','./subviews/PicturesView','./subviews/RunningManView'],function(require) {
  var Backbone = require('Backbone');
...
define('apps/pics/app',['require','./collections/PicturesCollection','./views/MainView'],function(require) {
...
/* START_TEMPLATE */
define('hbs!apps/admin/templates/EntrySelectorView',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  


  return "<div class=\"title\">Admin Area</div>\n<ul>\n  <div class=\"big-button\"><a href=\"/admin/glucoselog\">Glucose Entry</a></div>\n  <div class=\"big-button\"><a href=\"/admin/upload\">Photo Log</a></div>\n  <div class=\"big-button\"><a href=\"/admin/status\">Pedometer</a></div>\n</ul>\n";});
Handlebars.registerPartial('apps_admin_templates_EntrySelectorView', t);
return t;
});
/* END_TEMPLATE */
;
define('apps/admin/views/subviews/EntrySelectorView',['require','Backbone','hbs!./../../templates/EntrySelectorView'],function (require) {
  var Backbone = require('Backbone');
...
define('apps/admin/views/MainView',['require','Backbone','./subviews/EntrySelectorView'],function (require) {
  var Backbone = require('Backbone');
...
define('apps/admin/app',['require','./views/MainView'],function(require) {
  var MainView = require('./views/MainView');
...
(function (factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define('jQueryForm',['jquery'], factory);
    } else {
...
/* START_TEMPLATE */
define('hbs!apps/admin/subapps/imageuploader/templates/ImageUploaderView',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  


  return "<div class=\"back-nav\"><a href=\"/admin\">Back</a></div>\n<div class=\"page-title\">Insecure Admin Area</div>\n<div class=\"form-title\">Upload </div>\n<div class=\"form-wrap\">\n  <form id=\"uploadForm\" enctype=\"multipart/form-data\" action=\"/api/pics\" method=\"post\">\n    <input type=\"file\" id=\"userPhotoInput\" name=\"userPhoto\" class=\"user-photo\" />\n      <label for=\"photoComments\" class=\"form-label\" style=\"display:inline;text-align:left;\">Optional Comments</label>\n    <input type=\"text\" id=\"photoComments\" name=\"optionalPhotoComments\" placeholder=\"ex. 1 more min to go till a 7 min mile\" class=\"user-photo-text-input\" />\n    <br />\n    <div class=\"form-item-wrap\">\n      <label class=\"user-photo-checkbox form-label\">Mile Shot</label>\n      <input type=\"checkbox\" id=\"mileCheckBox\" name=\"isMile\" class=\"checkbox\" />\n    </div>\n    <div style=\"clear:both\"></div>\n    <br />\n    <div class=\"form-item-wrap\">\n      <label class=\"user-photo-checkbox form-label\">5k Shot</label> \n      <input type=\"checkbox\" id=\"5kCheckbox\" name=\"is5k\" class=\"checkbox\" />\n    </div>\n    <div style=\"clear:both\"></div>\n    <!-- <br /> -->\n    <div class=\"form-item-wrap\">\n      <a id=\"submit-button\"><div class=\"button\" id=\"submit-button\" type=\"submit\"><span class=\"submit-label\">Submit</span></div></a>\n    </div>\n  </form>\n</div>\n\n<span id=\"admin-status\">  </span>\n  <img id=\"uploadedImage\" />\n";});
Handlebars.registerPartial('apps_admin_subapps_imageuploader_templates_ImageUploaderView', t);
return t;
});
/* END_TEMPLATE */
;
define('apps/admin/subapps/imageuploader/views/subviews/ImageUploaderView',['require','Backbone','jQueryForm','hbs!./../../templates/ImageUploaderView'],function (require) {
  var Backbone = require('Backbone');
...
define('apps/admin/subapps/imageuploader/views/MainView',['require','Backbone','./subviews/ImageUploaderView'],function (require) {
  var Backbone = require('Backbone');
...
define('apps/admin/subapps/imageuploader/app',['require','./views/MainView'],function(require) {
  var MainView = require('./views/MainView');
...
/* START_TEMPLATE */
define('hbs!apps/admin/subapps/glucoselogger/templates/GlucoseEntryView',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  


  return "<div class=\"back-nav\"><a href=\"/admin\">Back</a></div>\n<div class=\"form-wrap\">\n  <form id=\"glucoseLog\" enctype=\"multipart/form-data\" action=\"/api/glucose\" method=\"post\">\n  <div class=\"form-item-wrap\">\n      <label for=\"glucoseLevel\" class=\"form-label glucose\" style=\"display:inline;\">Glucose Level</label>\n      <input type=\"text\" id=\"glucoseLevel\" name=\"bloodGlucoseLeve\" placeholder=\"mG\" class=\"glucose-number-input\" />\n    </div>\n    <div style=\"clear:both\"></div>\n    <div class=\"form-item-wrap\">\n      <label for=\"timeSinceEating\" class=\"form-label glucose\" style=\"display:inline;\">Time since eating</label>\n      <input type=\"number\" id=\"timeSinceEating\" name=\"timeSinceEating\" placeholder=\"min\" class=\"glucose-number-input time-since\" />\n    </div>\n    <div style=\"clear:both\"></div>\n    <br />\n    <div class=\"form-item-wrap\">\n      <label class=\"user-photo-checkbox form-label\">Notes (optional)</label> \n      <input type=\"text\" id=\"glucoseComments\" name=\"glucoseComments\" class=\"glucose-text-input\" />\n    </div>\n    <br />\n      <button id=\"submit-button\" type=\"submit\">Submit</button>\n  </form>\n</div>\n";});
Handlebars.registerPartial('apps_admin_subapps_glucoselogger_templates_GlucoseEntryView', t);
return t;
});
/* END_TEMPLATE */
;
define('apps/admin/subapps/glucoselogger/views/subviews/GlucoseEntryView',['require','Backbone','hbs!./../../templates/GlucoseEntryView'],function (require) {
  var Backbone = require('Backbone');
  var dispatcher = _.clone(Backbone.Events);
...
define('apps/admin/subapps/glucoselogger/views/MainView',['require','Backbone','./subviews/GlucoseEntryView'],function (require) {
  var Backbone = require('Backbone');
...
define('apps/admin/subapps/glucoselogger/app',['require','./views/MainView'],function(require) {
  var MainView = require('./views/MainView');
...
/* START_TEMPLATE */
define('hbs!apps/admin/subapps/status/templates/StatusView',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  


  return "<div class=\"back-nav\"><a href=\"/admin\">Back</a></div>\n\n<div class=\"status-container\">\n  <div class=\"page-title\">Pedometer</div>\n  <p>count: <span id=\"steps\"></span></p>\n  <br />\n  <button id=\"silent-audio\">Play</div>\n  <br />\n  <br />\n  <button id=\"pedometer\">start pedometer</div>\n\n\n</div>";});
Handlebars.registerPartial('apps_admin_subapps_status_templates_StatusView', t);
return t;
});
/* END_TEMPLATE */
;
define('apps/admin/subapps/status/views/subviews/Status',['require','Backbone','socketio','hbs!./../../templates/StatusView'],function (require) {
  var Backbone = require('Backbone');
...
define('apps/admin/subapps/status/views/MainView',['require','Backbone','./subviews/Status'],function (require) {
  var Backbone = require('Backbone');
...
define('apps/admin/subapps/status/app',['require','./views/MainView'],function(require) {
  var MainView = require('./views/MainView');
...
define('core/router',['require','Backbone','./viewManager','./../apps/home/app','./../apps/inbox/app','./../apps/inbox/subapps/compose/app','./../apps/charts/app','./../apps/status/app','./../apps/pics/app','./../apps/admin/app','./../apps/admin/subapps/imageuploader/app','./../apps/admin/subapps/glucoselogger/app','./../apps/admin/subapps/status/app'],function(require) {
	var Backbone = require('Backbone');
...
define('core/client',['require','jQuery','Backbone'],function (require) {
	var $ = require('jQuery');
	var Backbone = require('Backbone');
